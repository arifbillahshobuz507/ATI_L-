                                                        ...
                                                        <div class="menu-dropdown__column menu-dropdown__column-4 w-auto column-full no_show_product no_show_banner" data-masonry='{ "itemSelector": "[data-gridItem]", "columnWidth": ".grid-sizer" }'>
                                                            ...
                                                            <div class="site-nav dropdown menu-lv-blink" data-gridItem>
                                                                <div class="site-nav-list">
                                                                    <a href="https://new-ella-demo.myshopify.com/collections" class="site-nav-title menu_mobile_link_2">
                                                                        ...
                                                                        <ul class="list-unstyled">
                                                                            ...
                                                                            <li class="site-nav-item menu-lv-3 text-left">
                                                                                <a href="#" class="site-nav-link m-zero link link--text focus-inset caption-large link-effect">
                                                                                    <span class="text p-relative">test category</span>
                                                                                </a>
                                                                            </li>
                                ...
                                <predictive-search class="search-modal__form" data-loading-text="Loading..." data-product-to-show="5">
                                    <details class="search_details">
                                        <summary class="header__search-full" aria-haspopup="dialog" aria-label="Search">
                                            ...
                                            <a class="btn btn-success  p-3 " href="#">Regestetion</a>
                                            @endguest
                                            @auth
